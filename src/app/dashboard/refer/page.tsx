...
export default function ReferPage() {
  ...
  function shareSMS() {
    if (!data) return
    const text = `Yo — using BellAveGo: ${LEADS_PER_WEEK} fresh homeowner leads in my zip every week, AI texts each one as me, I only call the YES's. $97 first month w/ my link: ${data.referral_link}`
