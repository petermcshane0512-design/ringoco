  ...
  const rows = eligible.map((r) => {
    ...
    const body = previous === 0
      ...
      : previous === 1
        ...
        : `Last email from me, promise. Quick question first: was it the price, or do you just not need more ${r.trade || ''} jobs right now?\n\nEither answer helps me. And if it was neither — your first 2 weeks are FREE and your first ${LEADS_PER_WEEK} leads land in ~30 minutes, cancel anytime: bellavego.com/start?b=${r.biz_id}\n\n— Peter\n(773) 710-9565`
