...
const PLANS: Plan[] = [
  {
    ...
    features: [
      ...
      { label: 'A2P 10DLC SMS compliance done for you — we register your brand with the carriers so your customer texts actually deliver. Most platforms leave you to figure out the 1–14 day carrier setup yourself.', auto: true },
      ...
      { label: 'Up to 60 inbound calls / month (≈2 per day) — upgrade to Pro for unlimited when you outgrow it', auto: true },
      { label: '📅 Live calendar booking — your AI auto-books to your Google Calendar, Outlook, or Calendly (when connected)', auto: true },
