    ...
    <main style={{ fontFamily: "'Inter', system-ui, sans-serif", background: '#FFF8F0', color: '#0B1F3A', overflowX: 'hidden' }}>
        ...
        <div style={{ display: 'flex', gap: 16, alignItems: 'center' }}>
          ...
          {!isSignedIn && (
            <>
              ...
              <Link href="/start" style={navCTA}>2 weeks free →</Link>
            </>
          )}
        </div>
      </nav>
      ...
      <article className="fv4-article">
        ...
        <div className="fv4-prose">
          ...
          <p>
            Here&rsquo;s the part that makes it work: we <strong>prioritize the homeowners who genuinely have to get the job done</strong> &mdash; the ones the city has flagged to repair their property. They&rsquo;re not &ldquo;maybe interested.&rdquo; They&rsquo;re already looking for someone like you. So your calls land on people who want to hear from you, not strangers you&rsquo;re bugging. The franchise shops pay five-figure budgets for worse leads. You pay $197 — and your first 2 weeks are free.
          </p>
          <p>
          ...
          <div className="fv4-end">
            <Link href="/start" className="try">
              Try BellAveGo &mdash; 2 weeks free
