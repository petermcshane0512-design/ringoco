    ...
    <main style={{ fontFamily: "'Inter', system-ui, sans-serif", background: '#FFF8F0', color: '#0B1F3A', overflowX: 'hidden' }}>
      ...
      <article className="fv4-article">
        ...
        <div className="fv4-prose">
          ...
          <p>
            Homeowners who need work done aren&rsquo;t hard to find &mdash; permits, sold houses, aging units, storm damage. All public data. The franchise shops surface it with five-figure marketing budgets. Solo operators don&rsquo;t. So we built BellAveGo: <strong>{LEADS_PER_WEEK} fresh leads delivered every Monday</strong> ({LEADS_PER_MONTH}/month), exclusive to you, never shared. Each lead comes w/ a verified phone + pre-written outreach script our AI sends as you. You only call back the ones who say yes.
          </p>
          <p>
