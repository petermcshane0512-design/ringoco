...
function buildMethodology(reported: number, estimated: number, reportedCount: number, estimatedCount: number): string {
  ...
  return (
    ...
    'Narrative + opportunity ranking + action plan generated by Claude Sonnet 4.6, grounded in the inputs above. Every dollar figure is derived from the contractor\'s own numbers or from cited market data — no industry-aggregate claims.'
  )
}
