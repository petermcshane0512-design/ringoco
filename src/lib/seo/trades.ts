...
export const TRADES = [
  {
    ...
    metaDesc: (city: string) =>
      `Best AI receptionist for HVAC contractors in ${city}. Answer every missed call, book every job. $197/mo, 14-day free trial. No setup fee.`,
  },
  {
    slug: 'plumbing',
    label: 'Plumbing',
    ...
    metaDesc: (city: string) =>
      `AI receptionist for plumbers in ${city}. 24/7 call answering, lead capture, instant SMS dispatch. $197/mo, 14-day free trial.`,
  },
  {
    slug: 'electrical',
    label: 'Electrical',
    ...
    metaDesc: (city: string) =>
      `AI receptionist for electricians in ${city}. Capture every lead while you\'re on the job. $197/mo, 14-day free trial.`,
  },
  {
    slug: 'roofing',
    label: 'Roofing',
    ...
    metaDesc: (city: string) =>
      `AI receptionist for roofers in ${city}. Capture storm-damage calls 24/7. $197/mo, 14-day free trial.`,
  },
  {
    slug: 'cleaning',
    label: 'Cleaning',
    ...
    metaDesc: (city: string) =>
      `AI receptionist for residential cleaners in ${city}. Never miss a recurring-service booking. $197/mo, 14-day free trial.`,
  },
  {
    slug: 'landscaping',
    label: 'Landscaping',
    ...
    metaDesc: (city: string) =>
      `AI receptionist for landscapers in ${city}. Capture every spring-rush call. $197/mo, 14-day free trial.`,
  },
] as const
