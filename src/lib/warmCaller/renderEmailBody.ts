...
export function renderEmailText(input: RenderEmailInput): string {
  ...
  return [
    ...
    '',
    `Skip the $40K front-desk hire — first month free, then $197/mo, 30-day money-back guarantee, cancel any time.`,
    '',
    `— Peter`,
