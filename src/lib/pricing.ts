...
export const TIER_FEATURES: Record<LegacyTier, TierFeatures> = {
  ...
  officemgr: {
    tagline: 'Unlimited calls answered. 5 fresh neighborhood leads delivered every week. Or your money back.',
    callCap: 'Unlimited calls',
    leadsCadence: '5 leads/week (delivered every Monday)',
    leadsPerYear: 260,
    ...
    highlights: [
      ...
      '5 neighborhood leads delivered every Monday morning',
    ...
    features: [
      ...
      '5 fresh Neighborhood Leads delivered every Monday morning (260/year)',
      ...
      'PERFORMANCE GUARANTEE — Book at least 5 jobs from the AI in your first 30 days OR full refund. One-click cancel from your dashboard.',
