...
export const SAMPLE_REPORT: ConsultingReport = {
  ...
  methodology:
    ...
    'Narrative + opportunity ranking + action plan generated by Claude Sonnet 4.6, grounded in the inputs above. Every dollar figure derives from the contractor\'s own numbers or from cited market data — no industry-aggregate claims.',
}
