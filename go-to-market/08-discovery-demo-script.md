...
> "Cool. So here's what I'd suggest. Let's get u set up today on the AI Office Manager plan, $497/mo, first month free. We'll port ur main number forwarding tonight, ur dedicated AI number's live by tomorrow morning. I'll text u personally when it's ready. We run for 30 days — if u don't see at least 5 booked jobs u wouldn't have otherwise gotten, u get a full refund and u keep the data we collected. Sound fair?"
